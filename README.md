...
### 느낀점
잠시 잊고있었던 git과 github 그리고 버전관리에 관한 복습을 할 수 있었던 좋은 기회 였던 것 같습니다. github의 트레이드 마크 캐릭터였던 옥토캣이 **문어의 다리는 가진 고양이** 였다는 점이 다소 충격적이였지만, 수업 내용은 핵심만 간결하게 알려주어 수업에 잘 따라갈 수 있었던 것 같습니다. 

### Problem
큰 문제는 없었으나, 점심시간에 식사 후 조금 누워있었던 탓인지 오후시간에 다시 집중하는데 시간이 좀 걸렸음

## Try
점심시간에 식사 후 산책이나 가볍게 스트레칭을 하면서 다시 집중할 수 있도록 몸음 풀어 놓은다면 오후에도 빠르게 집중력을 되착고 수업에 참여할 수 있을것 같다
